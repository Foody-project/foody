        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-row items-center">
            ...
            <div className="flex flex-col mt-2 ml-2 text-sm text-[var(--text-basic)] font-thin mb-2">
              ...
              {isEditing ? (
                <div className="relative mt-1 w-[300%]">
                  <textarea
                    className="px-3 py-2 w-full text-sm rounded-md border border-[var(--border-muted)] bg-gray-200 text-[var(--text-basic)] focus:outline-none focus:ring-2 focus:ring-[var(--text-orange)] focus:border-transparent transition-all duration-200 resize-none shadow-sm placeholder:text-[var(--text-basic)]/40"
                    value={editedComment}
